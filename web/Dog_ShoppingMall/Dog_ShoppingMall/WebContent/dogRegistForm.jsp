<!-- ★★관리자 모드 : 새로운 개 상품 등록 정보를 입력하는 뷰페이지, 교재 754p -->
		...
		<form action="dogRegist.dog" method="post" name="writeForm" enctype="multipart/form-data">
			<table>
				...
				<tr>
					...
					<td class="td_right"> 
						<!-- wrap soft(기본값으로, 폼 데이터가 서버로 제출될 때 입력된 텍스트를 줄바꿈하지 않음.) -->
						<!-- <textarea></textarea>태그 떨어지지 않도록 입력하기(이유?떨어지면 커서가 처음에 존재하지 않게 되므로. 떨어진 공백만큼 화면에 적용되어서) -->
						<textarea name="content" rows="13" cols="40" wrap="soft"></textarea>
					</td>
				</tr>
				<tr>
